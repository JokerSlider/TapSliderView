...
@protocol  SimpleSliderLineViewDelegate <NSObject>
...
@interface SimpleTapSliderScrollView : UIView

@property (nonatomic,strong)    UIScrollView *pageScrollView;

@property (nonatomic,weak)id <SimpleSliderLineViewDelegate> delegate;
